        ...
        var body: some View {
            VStack(spacing: 0) {
                VStack(spacing: 0) {
                    ...
                    Text("Create a password for the account:")
                        .font(.bodyPrimary)
